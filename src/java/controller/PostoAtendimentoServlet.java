...
import model.PostoAtendimento;
import model.SecretariaSaude;

/**
 *
 * @author tiago
 */
@WebServlet(name = "PostoAtendimento", urlPatterns = "/postoAtendimento")
public class PostoAtendimentoServlet extends HttpServlet {
